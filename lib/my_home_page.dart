...
import 'package:warp_drive_weaver/widgets/tie_up_grid.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        // Added padding around the content for better spacing
          ...
          child: Directionality(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Consumer<WifNotifier>(
                  builder: (context, wifNotifier, child) {
                    final int shaftCount =
                        wifNotifier.currentWif.weavingSection?.shafts ?? 0;
                    return Text(
                      '$shaftCount',
                ...
                SizedBox(
                  // Constrain the width of the TextFormField
                  width: 150,
                  child: TextFormField(
                    initialValue:
                        context
                    ...
                    onFieldSubmitted: (value) {
                      ...
                      if (newShaftCount != null && newShaftCount > 0) {
                        // Basic validation
                        context
                            .read<WifNotifier>()
                            .weavingSectionNotifier
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Invalid shaft count. Please enter a positive number.',
                            ),
                          ),
                        );
                      }
                    ...
                    validator: (value) {
                      ...
                      if (number < 1) {
                        // Your minimum shaft count
                        return 'Must be at least 1';
                      }
                      if (number > 48) {
                        // Your maximum shaft count (example)
                    ...
                    autovalidateMode:
                        AutovalidateMode
                            .onUserInteraction, // Validate as user types or on submit
                  ),
                ),
                Expanded(
                  // Important if the GridView is in a Column
                  child: TieUpGrid(),
                ),
              ],
            ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          wifNotifier.weavingSectionNotifier
              .incrementShaftCount(); // Assuming you have this method
        },
